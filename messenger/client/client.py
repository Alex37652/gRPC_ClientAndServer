...
class MessageHandler(BaseHTTPRequestHandler):
    ...
    def _send_message(self, content: str) -> dict:
        ...
        request = google.protobuf.json_format.ParseDict(json_request, messenger_pb2.SendRequest())
...
def PutMessagesInPostbox(stub, postbox):
    for response in stub.ReadMessages(google.protobuf.empty_pb2.Empty()):
...
def main():
    ...
    # create your grpc client with given address
    ...
    thread = threading.Thread(target = PutMessagesInPostbox, args=(stub, postbox))
    thread.start()
